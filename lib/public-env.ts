...
export const unwrapQuotedEnvValue = (value: string): string => {
...
export const hasConfiguredEnvValue = (rawValue: string | null | undefined): boolean => (
...
export const readListValue = (rawValue: string | null | undefined): string[] => (
    (rawValue ?? '')
        .split(',')
