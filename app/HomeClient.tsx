...
export default function HomePage({ initialTerms = [] }: HomeClientProps) {
    ...
    return (
        <div className="page-content px-4 py-6">
            ...
            <header className="hidden md:flex items-center justify-between mb-12 py-8 border-b border-gray-100 dark:border-primary-700/50 bg-white/50 dark:bg-primary-800/80 backdrop-blur-md -mx-4 px-8 rounded-b-3xl relative z-50 shadow-sm">
