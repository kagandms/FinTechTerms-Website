...
const pageCopy: Record<Language, {
    ...
    ru: {
        ...
        description: 'Публичное описание многоязычного финтех-глоссария, редакционной архитектуры и академического уровня доверия.',
        backLabel: 'FinTechTerms',
        eyebrow: 'Публичный профиль проекта',
        focusLabel: 'Фокус',
        focusValue: 'Многоязычный финтех-глоссарий',
        standardLabel: 'Стандарт',
        standardValue: 'Публичные сигналы доверия и проверки',
        missionLabel: 'Кратко о проекте',
        architectureLabel: 'Модель доставки',
        peopleLabel: 'Слой ревью',
        missionTitle: 'Миссия',
        missionBody: 'FinTechTerms создаётся как многоязычный глоссарий и учебная инфраструктура для терминологии финтеха, финансов и технологий с сильными публичными сигналами доверия.',
        architectureTitle: 'Архитектура',
        architectureBody: 'Публичный SEO-контур серверно-рендерим, построен по языковой модели и опирается на сканируемые каталоги, тематические хабы и терминологические материалы с источниками.',
    ...
    tr: {
        ...
        architectureBody: 'Kamusal SEO katmanı sunucuda işlenir, dil tabanlıdır ve taranabilir sözlük dizinleri, konu merkezleri ve kaynak destekli terim sayfaları üzerine kuruludur.',
